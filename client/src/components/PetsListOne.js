...
const PetsListOne = (props) => {
    ...
    const likeHandler = (petLike, event) => {

        setPetLike(petLike, event)
                    ...
                    <div className="onePetsBackground" key={onePet._id}>
                        ...
                        <div className="onePetInfo">
                            ...
                            <div className="likesBox">
                                ...
                                <button className="mainButton likeButton" onClick={($event) => likeHandler(petLike + 1, $event)}>Give {onePet.petName} some love</button>
                            </div>
                        </div>
